...
write.csv(data_train, "D:/UPH/SMT 13/TA2/Data/Data/datatrain_cgksub.csv")
...
m3 <- rpart(formula = price~airline+departure+arrival+transit+day_of_week+holiday+days_left_until_departure+duration+scrape_day+scrape_holiday,
            data = data_train,
            method = "anova",
            control = list(minsplit = 20, maxdepth = 14, cp = 0.01)
)
saveRDS(m3, file = "D:/UPH/SMT 13/TA2/R Shiny/rt_cgksub.rda")
rpart.plot(m3)
